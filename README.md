...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "Arfin") || (event.body.toLowerCase() == "Arfin vai") || (event.body.toLowerCase() == "@Arfin Afi") || (event.body.toLowerCase() == "আরফিন")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ Arfin Afi ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 Arfin.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/Arfinafi69 \nতার সাতে যোগা যোগ করবেন WhatsApp :- +01755 নাহ দিবো না তাহলে আবার প্রেমের প্রস্তাব দিবা 😬", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:Arfin ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস আরফিন আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is Arfin  Islam Afi ❤️ তাকে সবাই আরফিন নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "sala ami tor boss") || (event.body.toLowerCase() == "sala ami Arfin") || (event.body.toLowerCase() == "cup sala ami Arfin") || (event.body.toLowerCase() == "madari")) {
     return api.sendMessage("সরি বস মাফ করে দেন আর এমন ভুল হবে না🥺🙏", threadID);
   };
/*
   if ((event.body.toLowerCase() == "@Farhana Ontora") || (event.body.toLowerCase() == "@Farhana Ontora ")) {
     return api.sendMessage("খবরদার কেউ এই আইড়ি মেনশন দিবানা এটা আমার বস আরফিন এর বউ এর আইড়ি😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "Farhana") || (event.body.toLowerCase() == "arohi")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস আরফিন এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "@MD Shiam Tafeder ") || (event.body.toLowerCase() == "সিয়াম")) {
     return api.sendMessage("🥰-সিয়াম-🌺 আমার বস আরফিন'র বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
*/
   ...
   if ((event.body.toLowerCase() == "Name") || (event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS °_>𝐀𝐑𝐅𝐈𝐍 𝐄𝐑 𝐂𝐇𝐀𝐓 𝐁𝐎𝐓", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "ex") || (event.body.toLowerCase() == "Ex")) {
     return api.sendMessage("️ কার নাম মুখে নিলি রে Sala Mood Khrab Kr Diya.🙄 আর কখনও এই নাম মুখে নিবি না কষ্ট লাগে😫", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "ভালো বাসে না") || (event.body.toLowerCase() == "amake kew valobashe na") || (event.body.toLowerCase() == "Aj kew nai bole")) {
   ...
   if ((event.body.toLowerCase() == "mon kharap") || (event.body.toLowerCase() == "মন খারাপ")) {
   ...
   if ((event.body.toLowerCase() == "ভালো বাসো") || (event.body.toLowerCase() == "tmi ki amake vlo basho")) {
     return api.sendMessage("হুম ঝাং আমি তোমাকে রাইতে ভলোপাসি <🥵", threadID);
   };

   if ((event.body.toLowerCase() == "ami Arfin") || (event.body.toLowerCase() == "kire")) {
